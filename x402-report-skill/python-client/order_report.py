#!/usr/bin/env python3
"""Standalone x402 buyer CLI for Parcelabot reports (any agent framework).

Identical to ``claude-skill/scripts/order_report.py`` — shipped here so the
Python client is self-contained.
...
USER_AGENT = "parcelabot-x402-client/1.0"
